...
import { GoogleGenAI, Type, Modality } from '@google/genai';
      ...
      const sectionsDefault = [{ id: 'about', title: 'About', visible: true }, { id: 'experience', title: 'Experience', visible: true }, { id: 'skills', title: 'Skills', visible: true }, { id: 'awards', title: 'Awards', visible: true }, { id: 'projects', title: 'Projects', visible: false }, { id: 'certifications', title: 'Certifications', visible: false }, { id: 'articles', title: 'Articles', visible: true }, { id: 'contact', title: 'Contact', visible: true }];
      const experienceDataDefault = [{ id: 1, date: '09/2022 - Present', title: 'Associate Claims (Accumulators)', company: 'Carelon Global Solutions', logoUrl: 'https://i.imgur.com/eQ7DNfR.png', showLogo: true, description: ['Carefully checked member enrollment details like names, birthdays, and insurance to ensure everything was correct.', 'Investigated and denied claims that were not covered, providing clear reasons to maintain fair processing.', 'Reviewed financial details like deductibles to find and fix errors, such as duplicate or incorrect charges.', 'Made precise adjustments to claims to correct any mistakes and ensure complete accuracy.', 'Tracked patient expenses to prevent over-charges and help them get the most out of their insurance benefits.', 'Ensured all claim processing followed insurance policy limits and company guidelines.'] }];
      const skillsDataDefault = [{ name: 'Claims Investigation', level: 95 }, { name: 'Policy Analysis', level: 90 }, { name: 'MS Office Suite', level: 92 }, { name: 'Regulatory Compliance', level: 88 }, { name: 'Data Accuracy', level: 98 }, { name: 'Clear Communication', level: 92 }, { name: 'Problem Solving', level: 90 }];
      const awardsDataDefault = [{ id: 1, name: 'Impact Award', date: 'September 2024', description: 'Recognized with the Impact Award for consistently delivering outstanding performance and exceeding expectations.' }, { id: 2, name: 'Impact Award', date: 'January 2024', description: 'Honored for exceptional contributions and a proactive approach to resolving complex claim discrepancies.' }, { id: 3, name: 'Impact Award', date: 'March 2023', description: 'Awarded for meticulous investigation skills and a commitment to ensuring accuracy in claims processing.' }];
      const articlesDataDefault = [{ id: 1, title: 'AI-Powered Claims: The Future is Now', description: 'Discover how automation and AI are transforming the insurance claims landscape for greater efficiency and accuracy.', imageUrl: 'https://picsum.photos/seed/claims-future/600/400', showImage: true, category: 'Insurtech', link: 'https://www.mckinsey.com/industries/financial-services/our-insights/the-future-of-insurance-claims-is-automated-and-ai-powered' }, { id: 2, title: 'The 2024 Healthcare Regulatory Outlook', description: 'An essential guide to the key regulatory trends and compliance challenges impacting the healthcare industry this year.', imageUrl: 'https://picsum.photos/seed/healthcare-regs/600/400', showImage: true, category: 'Compliance', link: 'https://www.pwc.com/us/en/industries/health-industries/library/health-regulatory-outlook.html' }, { id: 3, title: 'Why Data Accuracy is Crucial in Insurance', description: 'Learn about the significant impact of accurate data on risk management, underwriting, and customer trust in insurance.', imageUrl: 'https://picsum.photos/seed/data-accuracy/600/400', showImage: true, category: 'Best Practices', link: 'https://www.lexisnexis.com/en-us/blogs/risk-management/2023/07/importance-of-data-accuracy-in-insurance.page' }];
      const projectsDataDefault = [];
      const certificationsDataDefault = [];
      const securityDataDefault = { recoveryMethod: 'phrase', recoveryPhrase: '', recoveryQuestion: '', recoveryAnswer: '' };
      const aiFeaturesConfigDefault = { imageEditingEnabled: true, contentGenerationEnabled: true, showChatbot: true };
      ...
      // --- ICONS ---
      const LocationIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" /></svg>);
      const EmailIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg>);
      const PhoneIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.02.74-.25 1.02l-2.2 2.2z" /></svg>);
      const LinkedInIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14zm-11 6H5v9h3V9zm-1.5-2.25A1.75 1.75 0 0 0 5 8.5a1.75 1.75 0 0 0 3.5 0A1.75 1.75 0 0 0 6.5 6.75zM19 9h-2.83c.03-.22.03-.43.03-.65 0-2.3-1.87-4.18-4.17-4.18A4.18 4.18 0 0 0 8 8.35V9H5v9h3v-4.5c0-1.38.62-2.5 2.25-2.5S13 13.12 13 14.5V18h3v-5.04c0-2.23-1.2-3.96-3.03-3.96C11.33 9 10.02 10.3 10 11.4V12h3.17L13 18h3v-5c0-1.38.62-2.5 2.25-2.5S19 12.12 19 13.5V18h3v-9z" /></svg>);
      const AwardIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 17 17 23 15.79 13.88"></polyline></svg>);
      const MagicWandIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M20.71,9.29,19,7.58,16.42,5,18.13,3.29a1,1,0,0,0,0-1.42,1,1,0,0,0-1.41,0L15,3.58,12.42,1,10.71,2.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0L13.83,2.42l2,2L14.12,6.12a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0L17.24,5.83l2,2L17.58,9.54a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0L20.71,9.29ZM19.24,14.5a3.47,3.47,0,0,1-2.47.75,3.45,3.45,0,0,1-2.47-1,1,1,0,0,0-1.42,0,1,1,0,0,0,0,1.41,5.46,5.46,0,0,0,7.78,0,1,1,0,0,0-1.42-1.41ZM7.48,10.5a3.49,3.49,0,0,1,0-5,1,1,0,0,0-1.42-1.41,5.49,5.49,0,0,0,0,7.78,1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.41A3.41,3.41,0,0,1,7.48,10.5ZM12,19.34a.84.84,0,0,1-.59-.24L8.5,16.19a3.25,3.25,0,0,1,0-4.6l.7-.71a1,1,0,0,0-1.41-1.41l-.71.71a5.25,5.25,0,0,0,0,7.42l2.92,2.91a.84.84,0,0,1-.59,1.43H3.84a1,1,0,0,0,0,2H8.54a2.83,2.83,0,0,0,2-4.82l.85-.85a1,1,0,1,0-1.41-1.41l-.85.85a.86.86,0,0,1-1.15.34.81.81,0,0,1-.6-.57,1,1,0,0,0-1-.78,1,1,0,0,0-1,.78.81.81,0,0,1-.6.57.86.86,0,0,1-1.15-.34L3,14.3a1,1,0,0,0-1.41,1.41L3,17.12a3.25,3.25,0,0,1,0,4.6l2.91,2.92a.84.84,0,0,1,.59.24.84.84,0,0,1,.59-.24l2.91-2.92a3.25,3.25,0,0,1,0-4.6l-.7-.71a1,1,0,0,0-1.41,1.41l.7.71a1.25,1.25,0,0,0,1.77,0l2.91-2.92a1.25,1.25,0,0,0,0-1.77L13.18,12.4a1,1,0,1,0-1.41,1.41l2.35,2.35a3.25,3.25,0,0,1,0,4.6Z"/></svg>);
      const ChatIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 9h12v2H6V9zm8 5H6v-2h8v2zm4-6H6V6h12v2z"/></svg>);
      ...
      const SunIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zM12 9c1.65 0 3 1.35 3 3s-1.35 3-3 3-3-1.35-3-3 1.35-3 3-3zm0-7c.55 0 1 .45 1 1v2c0 .55-.45 1-1 1s-1-.45-1-1V3c0-.55.45-1 1-1zm0 18c.55 0 1 .45 1 1v2c0 .55-.45 1-1 1s-1-.45-1-1v-2c0-.55.45-1 1-1zm-8-9c-.55 0-1-.45-1-1H1c-.55 0-1-.45-1-1s.45-1 1-1h2c.55 0 1 .45 1 1s-.45 1-1 1zm18 0c-.55 0-1-.45-1-1h-2c-.55 0-1-.45-1-1s.45-1 1-1h2c.55 0 1 .45 1 1s-.45 1-1 1zM5.64 5.64c-.39-.39-1.02-.39-1.41 0s-.39 1.02 0 1.41l1.41 1.41c.39.39 1.02.39 1.41 0s.39-1.02 0-1.41L5.64 5.64zm12.72 12.72c-.39-.39-1.02-.39-1.41 0s-.39 1.02 0 1.41l1.41 1.41c.39.39 1.02.39 1.41 0s.39-1.02 0-1.41l-1.41-1.41zM5.64 18.36c.39-.39.39-1.02 0-1.41s-1.02-.39-1.41 0l-1.41 1.41c-.39.39-.39 1.02 0 1.41s1.02.39 1.41 0l1.41-1.41zm12.72-12.72c.39-.39.39-1.02 0-1.41s-1.02-.39-1.41 0l-1.41 1.41c-.39.39-.39 1.02 0 1.41s1.02.39 1.41 0l1.41-1.41z"/></svg>);
      const MoonIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9c0-.46-.04-.92-.1-1.36-.98 1.37-2.58 2.26-4.4 2.26-2.98 0-5.4-2.42-5.4-5.4 0-1.82.89-3.42 2.26-4.4-.44-.06-.9-.1-1.36-.1z" /></svg>);
      const DownloadIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>);
      ...
      const Header = ({ personalInfo, navLinks, theme, toggleTheme }) => {
        ...
        useEffect(() => {
          const handleScroll = () => {
            ...
            sections.forEach(section => {
              // FIX: Cast section to HTMLElement to access offsetTop
      ...
      const Hero = ({ personalInfo }) => {
        ...
        useEffect(() => {
          ...
          const light1 = new THREE.PointLight(0x00f6ff, 2);
          light1.position.set(5, 5, 5);
          scene.add(light1);
          
          const light2 = new THREE.PointLight(0xd400ff, 2);
        ...
        return (
          <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-bg-primary">
            <div id="hero-canvas" ref={mountRef}></div>
              ...
              <div className={`text-center md:text-left transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="flex justify-center md:justify-start gap-4 flex-wrap">
                  ...
                  {personalInfo.showCvButton && personalInfo.cvUrl && (
                     <a href={personalInfo.cvUrl} download className="text-white bg-transparent border-2 border-accent-secondary hover:bg-accent-secondary/20 focus:ring-4 focus:outline-none focus:ring-purple-300/50 font-medium rounded-lg text-base px-6 py-3 text-center transition-all duration-300 flex items-center gap-2">
...
// FIX: Update component definition to use React.FC to correctly type props and resolve issues with 'children' prop.
const Section: React.FC<{id: string; title: string; titleAccent: string;}> = ({ id, title, titleAccent, children }) => {
      ...
      const About = ({ personalInfo, educationData }) => {
          const [ref, isVisible] = useOnScreen({ threshold: 0.3 });
          return (
            <Section id="about" title="About" titleAccent="Me">
              <p ref={ref} className={`max-w-3xl mx-auto text-center text-text-secondary text-lg mb-16 fade-in-up ${isVisible ? 'visible' : ''}`}>
                {personalInfo.summary}
              </p>
              <div ref={ref} className={`max-w-4xl mx-auto bg-bg-glass backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-2xl shadow-black/20 border border-border-color fade-in-up ${isVisible ? 'visible' : ''}`} style={{transitionDelay: '200ms'}}>
          ...
          <Section id="experience" title="Work" titleAccent="Experience">
            <div ref={ref} className="relative max-w-3xl mx-auto">
              {experienceData.map((item, index) => (
                <div key={index} className="relative pl-12 md:pl-16 pb-12">
...
// FIX: Update component definition to use React.FC to correctly type props and resolve issues with the 'key' prop.
const SkillCircle: React.FC<{level: number, name: string, isVisible: boolean, index: number}> = ({ level, name, isVisible, index }) => {
                ...
                <div key={project.id} className={`bg-bg-glass backdrop-blur-md rounded-2xl overflow-hidden shadow-2xl shadow-black/20 border border-border-color group transition-all duration-500 hover:-translate-y-2 hover:shadow-accent-primary/20 fade-in-up ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: `${index * 150}ms` }}>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.tags.map(tag => (<span key={tag} className="text-xs font-semibold bg-slate-700 text-accent-primary py-1 px-3 rounded-full">{tag}</span>))}
                      </div>
                    </div>
                </div>
              ))}
          ...
          <Section id="certifications" title="Licenses &" titleAccent="Certifications">
            <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {certificationsData.map((cert, index) => (
                <div key={cert.id} className={`bg-bg-glass backdrop-blur-md p-6 rounded-2xl shadow-2xl shadow-black/20 border border-border-color group transition-all duration-500 hover:-translate-y-2 hover:shadow-accent-primary/20 fade-in-up ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: `${index * 150}ms` }}>
                    <div className="flex items-start gap-4">
                        {cert.showImage && cert.imageUrl && <img src={cert.imageUrl} alt={cert.name} className="w-16 h-16 object-contain"/>}
                        <div className="flex-1">
                            ...
                            {cert.credentialUrl && (<a href={cert.credentialUrl} target="_blank" rel="noopener noreferrer" className="text-sm text-accent-primary hover:text-accent-primary/80 transition-colors mt-2 inline-block">Show Credential &rarr;</a>)}
                        </div>
                    </div>
                </div>
              ))}
      ...
      const Contact = ({ personalInfo }) => {
        ...
        const handleSubmit = async (e) => {
          ...
          if (!API_KEY) {
              setFormStatus({ status: 'error', message: 'Contact form is currently disabled. Please reach out via email directly.' });
              return;
          }
          ...
          try {
            ...
            const sendEmailDeclaration = { name: 'send_email', parameters: { type: Type.OBJECT, properties: { to: { type: Type.STRING }, from_name: { type: Type.STRING }, from_email: { type: Type.STRING }, message: { type: Type.STRING } }, required: ['to', 'from_name', 'from_email', 'message'] } };
            const sendSmsDeclaration = { name: 'send_sms', parameters: { type: Type.OBJECT, properties: { to_phone: { type: Type.STRING }, from_name: { type: Type.STRING }, message: { type: Type.STRING } }, required: ['to_phone', 'from_name', 'message'] } };
            
            const targetPhone = personalInfo.notificationPhone || personalInfo.phone;
            const prompt = `A user, ${formData.name} (${formData.email}), has submitted the following message through the portfolio contact form: "${formData.message}". The portfolio owner, ${personalInfo.name}, has requested to be notified via ${personalInfo.notificationMethod}. Please call the appropriate function to send this notification. The owner's email is ${personalInfo.email} and their phone number is ${targetPhone}.`;

            const response = await ai.models.generateContent({
              model: 'gemini-2.5-flash',
              contents: { parts: [{ text: prompt }] },
              config: { tools: [{ functionDeclarations: [sendEmailDeclaration, sendSmsDeclaration] }] },
            });

            const functionCall = response.functionCalls && response.functionCalls[0];
            if (functionCall) {
                if (functionCall.name === 'send_email') {
                    setFormStatus({ status: 'success', message: `Thank you! Your message has been sent, and ${personalInfo.name.split(' ')[0]} will be notified by email.` });
                } else if (functionCall.name === 'send_sms') {
                    setFormStatus({ status: 'success', message: `Thank you! Your message has been sent, and ${personalInfo.name.split(' ')[0]} will be notified by SMS.` });
                } else {
                    setFormStatus({ status: 'success', message: "Thank you for your message! I'll get back to you shortly." });
                }
            } else {
            ...
            setFormStatus({ status: 'error', message: "Sorry, something went wrong. Please try again or email me directly." });
          }
        };
        ...
        return (
          <Section id="contact" title="Contact" titleAccent="Me">
            <div ref={ref} className={`max-w-5xl mx-auto grid md:grid-cols-2 gap-12 bg-bg-glass backdrop-blur-lg p-8 md:p-12 rounded-2xl shadow-2xl border border-border-color fade-in-up ${isVisible ? 'visible' : ''}`}>
      ...
      const Chatbot = ({ portfolioData }) => {
        ...
        useEffect(() => {
          ...
          const ai = new GoogleGenAI({ apiKey: API_KEY });
          const context = `Name: ${portfolioData.personalInfo.name}; Title: ${portfolioData.personalInfo.title}; Summary: ${portfolioData.personalInfo.summary}; Contact Email: ${portfolioData.personalInfo.email}; Contact Phone: ${portfolioData.personalInfo.phone}; LinkedIn: ${portfolioData.personalInfo.linkedin}; Experience: ${portfolioData.experienceData.map(job => `${job.title} at ${job.company}: ${job.description.join('. ')}`).join('; ')}; Skills: ${portfolioData.skillsData.map(skill => `${skill.name}`).join(', ')};`;
      ...
      const Admin = () => {
          ...
          const [experienceData, setExperienceData] = useState(() => loadData('experienceData', experienceDataDefault));
          const [skillsData, setSkillsData] = useState(() => loadData('skillsData', skillsDataDefault));
          const [awardsData, setAwardsData] = useState(() => loadData('awardsData', awardsDataDefault));
          const [articlesData, setArticlesData] = useState(() => loadData('articlesData', articlesDataDefault));
          const [projectsData, setProjectsData] = useState(() => loadData('projectsData', projectsDataDefault));
          const [certificationsData, setCertificationsData] = useState(() => loadData('certificationsData', certificationsDataDefault));
          const [sections, setSections] = useState(() => loadData('sectionsConfig', sectionsDefault));
          const [aiFeaturesConfig, setAiFeaturesConfig] = useState(() => loadData('aiFeaturesConfig', aiFeaturesConfigDefault));

          // --- AI MODAL STATE ---
          const [isAiModalOpen, setIsAiModalOpen] = useState(false);
          const [aiImageData, setAiImageData] = useState({ currentImage: '', onSave: null });

          const openAiModal = (currentImage, onSave) => {
          ...
          const handleGenerateAI = async (key, promptText, currentValue, updaterFn) => {
          ...
          const saveData = (key, data) => { localStorage.setItem(key, JSON.stringify(data)); alert(`${key.replace(/Data|Config/g, '')} saved!`); };
          // FIX: Add default value for isArray param
          const handleItemChange = (setter, index, field, value, isArray = false) => { setter(prev => prev.map((item, i) => i === index ? {...item, [field]: isArray ? value.split('\n') : value} : item)); };
          ...
          const AIGenerateButton = ({ fieldKey, prompt, currentValue, onGenerated }) => (<button type="button" onClick={() => handleGenerateAI(fieldKey, prompt, currentValue, onGenerated)} disabled={isGenerating || !API_KEY || !aiFeaturesConfig.contentGenerationEnabled} className="ml-2 p-2 btn-admin btn-admin-accent rounded-md flex items-center text-sm disabled:opacity-50"><MagicWandIcon className="w-4 h-4 mr-2" />{isGenerating && generatingKey === fieldKey ? '...' : 'Enhance'}</button>);
          // FIX: Add default value for props to handle calls with fewer than 5 arguments.
          const renderInput = (label, value, onChange, type = "text", props = {}) => (<div className="mb-4"><label className="block text-slate-300 text-sm font-bold mb-2">{label}</label><input type={type} value={value} onChange={onChange} className="shadow appearance-none border rounded w-full py-2 px-3 bg-slate-700 border-slate-600 text-white leading-tight focus:outline-none focus:shadow-outline focus:border-accent-primary" {...props}/></div>);
          const renderTextarea = (label, value, onChange, aiOptions = null) => (<div className="mb-4"><div className="flex justify-between items-center mb-2"><label className="block text-slate-300 text-sm font-bold">{label}</label>{aiOptions && <AIGenerateButton {...aiOptions} />}</div><textarea value={value} onChange={onChange} rows={5} className="shadow appearance-none border rounded w-full py-2 px-3 bg-slate-700 border-slate-600 text-white leading-tight focus:outline-none focus:shadow-outline focus:border-accent-primary min-h-[120px]"/></div>);
// FIX: Update component definition to use React.FC to correctly type props and resolve issues with the 'key' prop.
const ToggleSwitch: React.FC<{label: string; checked: boolean; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void}> = ({ label, checked, onChange }) => (<div className="flex items-center justify-between my-4 py-2 border-b border-t border-border-color"><span className="text-slate-300 font-bold">{label}</span><label className="relative inline-flex items-center cursor-pointer"><input type="checkbox" checked={checked} onChange={onChange} className="sr-only peer" /><div className="w-11 h-6 bg-slate-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-accent-primary/50 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-accent-secondary"></div></label></div>);
          const RadioGroup = ({ label, name, options, value, onChange }) => (<div className="mb-4"><label className="block text-slate-300 text-sm font-bold mb-2">{label}</label><div className="flex gap-4">{options.map(opt => (<label key={opt.value} className="flex items-center"><input type="radio" name={name} value={opt.value} checked={value === opt.value} onChange={onChange} className="w-4 h-4 text-accent-secondary bg-slate-600 border-slate-500 focus:ring-accent-secondary focus:ring-2" /> <span className="ml-2 text-white">{opt.label}</span></label>))}</div></div>);
          
          const ImageInput = ({ label, imageUrl, onUrlChange, onFileChange, onAiEdit, showImageToggle, isImageShown, onImageToggleChange }) => {
            return (
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                    <label className="block text-slate-300 text-sm font-bold">{label}</label>
                    {showImageToggle && (
                        <div className="flex items-center">
                            <span className="text-xs mr-2 text-slate-400">Show Image</span>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <input type="text" value={imageUrl || ''} onChange={onUrlChange} placeholder="Paste image URL" className="shadow appearance-none border rounded w-full py-2 px-3 bg-slate-700 border-slate-600 text-white leading-tight focus:outline-none focus:shadow-outline focus:border-accent-primary mb-2"/>
                    <div className="flex items-center gap-2">
                      ...
                      <button type="button" onClick={onAiEdit} disabled={!API_KEY || !aiFeaturesConfig.imageEditingEnabled} className="p-2 bg-gradient-accent rounded-md text-black disabled:opacity-50 flex items-center text-sm"><MagicWandIcon className="w-4 h-4" /></button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          const AIImageEditModal = ({ isOpen, onClose, imageData, onSave }) => {
            ...
            const handleGenerate = async () => {
              ...
              try {
                const ai = new GoogleGenAI({ apiKey: API_KEY });
                // FIX: Add a check for editedImage before splitting
                const [header, base64Data] = editedImage ? editedImage.split(',') : ['', ''];
            ...
            const handleSave = () => { onSave(editedImage); onClose(); };
          ...
          const tabs = [ { id: 'sections', label: 'Manage Sections' }, { id: 'personal', label: 'Personal Info' }, { id: 'experience', label: 'Experience' }, { id: 'skills', label: 'Skills' }, { id: 'awards', label: 'Awards' }, { id: 'projects', label: 'Projects' }, { id: 'certifications', label: 'Certifications' }, { id: 'articles', label: 'Articles' }, { id: 'security', label: 'Security' }];
          return (
            <>
              <AIImageEditModal isOpen={isAiModalOpen} onClose={() => setIsAiModalOpen(false)} imageData={aiImageData} onSave={aiImageData.onSave} />
              <div className="min-h-screen bg-bg-primary text-white flex">
                  <aside className="w-64 bg-bg-secondary p-4 border-r border-border-color flex flex-col">
                  ...
                  <main className="flex-grow p-8 overflow-y-auto">
                    {!API_KEY && (
                      <div className="bg-amber-500/10 border border-amber-500 text-amber-300 p-4 rounded-lg mb-6 text-sm">
                          ...
                          <p>To enable AI-powered content generation and image editing, please set your <code className="bg-black/30 px-1 rounded-sm">API_KEY</code> in the deployment environment variables of your hosting provider (e.g., Netlify, Vercel).</p>
                      </div>
                    )}
                    {activeTab === 'sections' && (
                        <div>
                            <h2 className="text-3xl font-bold mb-2 text-white font-heading">Manage Page Sections</h2>
                    ...
                    {activeTab === 'personal' && (
                        <div>
                            <h2 className="text-3xl font-bold mb-6 font-heading">Edit Personal & Education Info</h2>
                            <div className="grid md:grid-cols-2 gap-8">
                              <div className="bg-bg-secondary p-6 rounded-lg border border-border-color">
                                  ...
                                  {renderTextarea("Summary", personalInfo.summary, e => setPersonalInfo({...personalInfo, summary: e.target.value}), { fieldKey: 'summary', prompt: "Rewrite this summary for a Claims Associate's portfolio.", currentValue: personalInfo.summary, onGenerated: (newText) => setPersonalInfo({...personalInfo, summary: newText})})}
                                  {renderTextarea("Contact Intro", personalInfo.contactIntro, e => setPersonalInfo({...personalInfo, contactIntro: e.target.value}), { fieldKey: 'contactIntro', prompt: "Rewrite this contact section intro text.", currentValue: personalInfo.contactIntro, onGenerated: (newText) => setPersonalInfo({...personalInfo, contactIntro: newText})})}
                                  ...
                                  <div className="mt-6 pt-6 border-t border-border-color">
                                    ...
                                    />
                                    {personalInfo.notificationMethod === 'sms' && (
                                       renderInput("Notification Phone Number", personalInfo.notificationPhone, e => setPersonalInfo({...personalInfo, notificationPhone: e.target.value}), "tel", { placeholder: personalInfo.phone })
                                    )}
                                  </div>
                              ...
                              <div className="bg-bg-secondary p-6 rounded-lg border border-border-color">
                                ...
                                <ImageInput label="Education Image" imageUrl={personalInfo.educationImageUrl} onUrlChange={e => setPersonalInfo({...personalInfo, educationImageUrl: e.target.value})} onFileChange={async e => setPersonalInfo({...personalInfo, educationImageUrl: await fileToBase64(e.target.files[0])})} onAiEdit={() => openAiModal(personalInfo.educationImageUrl, (newImg) => setPersonalInfo({...personalInfo, educationImageUrl: newImg}))} showImageToggle={true} isImageShown={!!personalInfo.showEducationImage} onImageToggleChange={e => setPersonalInfo({...personalInfo, showEducationImage: e.target.checked})} />
                    ...
                    {activeTab === 'experience' && (
                        <div>
                            <h2 className="text-3xl font-bold mb-6 font-heading">Edit Experience</h2>
                            <div className="space-y-6">
                                {experienceData.map((item, index) => (
                                    <div key={item.id || index} className="bg-bg-secondary p-6 rounded-lg border border-border-color relative">
                                        <button onClick={() => handleRemoveItem(setExperienceData, index)} className="absolute top-4 right-4 btn-admin-close"><CloseIcon className="w-6 h-6" /></button>
                                        <h3 className="text-lg font-semibold text-accent-primary mb-2">Item #{index + 1}</h3>
                                        {/* FIX: Explicitly pass all arguments to handleItemChange */}
                                        {renderInput(`Date`, item.date, e => handleItemChange(setExperienceData, index, 'date', e.target.value, false))}
                                        {renderInput(`Title`, item.title, e => handleItemChange(setExperienceData, index, 'title', e.target.value, false))}
                                        {renderInput(`Company`, item.company, e => handleItemChange(setExperienceData, index, 'company', e.target.value, false))}
                                        <ImageInput label="Company Logo" imageUrl={item.logoUrl} onUrlChange={e => handleItemChange(setExperienceData, index, 'logoUrl', e.target.value, false)} onFileChange={async e => handleItemChange(setExperienceData, index, 'logoUrl', await fileToBase64(e.target.files[0]), false)} onAiEdit={() => openAiModal(item.logoUrl, (newImg) => handleItemChange(setExperienceData, index, 'logoUrl', newImg, false))} showImageToggle={true} isImageShown={!!item.showLogo} onImageToggleChange={e => handleItemChange(setExperienceData, index, 'showLogo', e.target.checked, false)} />
                     ...
                     {activeTab === 'skills' && (
                        <div>
                            <h2 className="text-3xl font-bold mb-6 font-heading">Edit Skills</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {skillsData.map((item, index) => (
                                    <div key={index} className="bg-bg-secondary p-6 rounded-lg border border-border-color relative">
                                        <button onClick={() => handleRemoveItem(setSkillsData, index)} className="absolute top-4 right-4 btn-admin-close"><CloseIcon className="w-6 h-6" /></button>
                                        <h3 className="text-lg font-semibold text-accent-primary mb-2">Skill #{index + 1}</h3>
                                        {/* FIX: Explicitly pass all arguments to handleItemChange */}
                                        {renderInput(`Name`, item.name, e => handleItemChange(setSkillsData, index, 'name', e.target.value, false))}
                                        {renderInput(`Level (0-100)`, item.level, e => handleItemChange(setSkillsData, index, 'level', e.target.value, false), 'number', {min: 0, max: 100})}
                                    </div>
                                ))}
                            </div>
                    ...
                    {activeTab === 'awards' && (
                        <div>
                            <h2 className="text-3xl font-bold mb-6 font-heading">Edit Awards</h2>
                            <div className="space-y-6">
                                {awardsData.map((item, index) => (
                                    <div key={item.id || index} className="bg-bg-secondary p-6 rounded-lg border border-border-color relative">
                                        <button onClick={() => handleRemoveItem(setAwardsData, index)} className="absolute top-4 right-4 btn-admin-close"><CloseIcon className="w-6 h-6" /></button>
                                        <h3 className="text-lg font-semibold text-accent-primary mb-2">Award #{index + 1}</h3>
                                        {/* FIX: Explicitly pass all arguments to handleItemChange */}
                                        {renderInput(`Name`, item.name, e => handleItemChange(setAwardsData, index, 'name', e.target.value, false))}
                                        {renderInput(`Date`, item.date, e => handleItemChange(setAwardsData, index, 'date', e.target.value, false))}
                                        {renderTextarea(`Description`, item.description, e => handleItemChange(setAwardsData, index, 'description', e.target.value, false))}
                                    </div>
                                ))}
                            </div>
                    ...
                    {activeTab === 'projects' && (
                        <div>
                            <h2 className="text-3xl font-bold mb-6 font-heading">Edit Projects</h2>
                            <div className="space-y-6">
                                {projectsData.map((item, index) => (
                                    <div key={item.id || index} className="bg-bg-secondary p-6 rounded-lg border border-border-color relative">
                                        <button onClick={() => handleRemoveItem(setProjectsData, index)} className="absolute top-4 right-4 btn-admin-close"><CloseIcon className="w-6 h-6" /></button>
                                        <h3 className="text-lg font-semibold text-accent-primary mb-2">Project #{index + 1}</h3>
                                        {/* FIX: Explicitly pass all arguments to handleItemChange */}
                                        {renderInput(`Title`, item.title, e => handleItemChange(setProjectsData, index, 'title', e.target.value, false))}
                                        <ImageInput label="Project Image" imageUrl={item.imageUrl} onUrlChange={e => handleItemChange(setProjectsData, index, 'imageUrl', e.target.value, false)} onFileChange={async e => handleItemChange(setProjectsData, index, 'imageUrl', await fileToBase64(e.target.files[0]), false)} onAiEdit={() => openAiModal(item.imageUrl, (newImg) => handleItemChange(setProjectsData, index, 'imageUrl', newImg, false))} showImageToggle={true} isImageShown={!!item.showImage} onImageToggleChange={e => handleItemChange(setProjectsData, index, 'showImage', e.target.checked, false)} />
                                        {renderInput(`Live URL`, item.liveUrl, e => handleItemChange(setProjectsData, index, 'liveUrl', e.target.value, false))}
                                        {renderInput(`Source URL`, item.sourceUrl, e => handleItemChange(setProjectsData, index, 'sourceUrl', e.target.value, false))}
                                        {renderTextarea(`Description`, item.description, e => handleItemChange(setProjectsData, index, 'description', e.target.value, false))}
                                        {renderInput(`Tags (comma separated)`, Array.isArray(item.tags) ? item.tags.join(', ') : '', e => setProjectsData(prev => prev.map((p, i) => i === index ? {...p, tags: e.target.value.split(',').map(t=>t.trim())} : p)))}
                                    </div>
                                ))}
                            </div>
                    ...
                    {activeTab === 'certifications' && (
                        <div>
                            <h2 className="text-3xl font-bold mb-6 font-heading">Edit Certifications</h2>
                             <div className="space-y-6">
                                {certificationsData.map((item, index) => (
                                    <div key={item.id || index} className="bg-bg-secondary p-6 rounded-lg border border-border-color relative">
                                        <button onClick={() => handleRemoveItem(setCertificationsData, index)} className="absolute top-4 right-4 btn-admin-close"><CloseIcon className="w-6 h-6" /></button>
                                        <h3 className="text-lg font-semibold text-accent-primary mb-2">Certification #{index + 1}</h3>
                                        {/* FIX: Explicitly pass all arguments to handleItemChange */}
                                        {renderInput(`Name`, item.name, e => handleItemChange(setCertificationsData, index, 'name', e.target.value, false))}
                                        {renderInput(`Issuer`, item.issuer, e => handleItemChange(setCertificationsData, index, 'issuer', e.target.value, false))}
                                        {renderInput(`Date`, item.date, e => handleItemChange(setCertificationsData, index, 'date', e.target.value, false))}
                                        {renderInput(`Credential URL`, item.credentialUrl, e => handleItemChange(setCertificationsData, index, 'credentialUrl', e.target.value, false))}
                                        <ImageInput label="Certification/Logo Image" imageUrl={item.imageUrl} onUrlChange={e => handleItemChange(setCertificationsData, index, 'imageUrl', e.target.value, false)} onFileChange={async e => handleItemChange(setCertificationsData, index, 'imageUrl', await fileToBase64(e.target.files[0]), false)} onAiEdit={() => openAiModal(item.imageUrl, (newImg) => handleItemChange(setCertificationsData, index, 'imageUrl', newImg, false))} showImageToggle={true} isImageShown={!!item.showImage} onImageToggleChange={e => handleItemChange(setCertificationsData, index, 'showImage', e.target.checked, false)} />
                                    </div>
                                ))}
                            </div>
                            <button onClick={() => handleAddItem(setCertificationsData, { name: '', issuer: '', date: '', credentialUrl: '', imageUrl: '', showImage: true })} className="mt-6 btn-admin btn-admin-success">Add Certification</button>
                    ...
                    {activeTab === 'articles' && (
                        <div>
                            <h2 className="text-3xl font-bold mb-6 font-heading">Edit Articles & Insights</h2>
                             <div className="space-y-6">
                                {articlesData.map((item, index) => (
                                    <div key={item.id || index} className="bg-bg-secondary p-6 rounded-lg border border-border-color relative">
                                        <button onClick={() => handleRemoveItem(setArticlesData, index)} className="absolute top-4 right-4 btn-admin-close"><CloseIcon className="w-6 h-6" /></button>
                                        <h3 className="text-lg font-semibold text-accent-primary mb-2">Article #{index + 1}</h3>
                                        <div className="mb-4">
                                            <div className="flex justify-between items-center mb-2">
                                                <label className="block text-slate-300 text-sm font-bold">Title</label>
                                                <AIGenerateButton
                                                    fieldKey={`article_title_${index}`}
                                                    prompt="Rewrite this article title to be more engaging."
                                                    currentValue={item.title}
                                                    onGenerated={(newText) => handleItemChange(setArticlesData, index, 'title', newText, false)}
                                                />
                                            </div>
                                            {/* FIX: Explicitly pass all arguments to handleItemChange */}
                                            <input type="text" value={item.title} onChange={e => handleItemChange(setArticlesData, index, 'title', e.target.value, false)} className="shadow appearance-none border rounded w-full py-2 px-3 bg-slate-700 border-slate-600 text-white leading-tight focus:outline-none focus:shadow-outline focus:border-accent-primary" />
                                        </div>
                                        {renderInput(`Category`, item.category, e => handleItemChange(setArticlesData, index, 'category', e.target.value, false))}
                                        <ImageInput label="Article Image" imageUrl={item.imageUrl} onUrlChange={e => handleItemChange(setArticlesData, index, 'imageUrl', e.target.value, false)} onFileChange={async e => handleItemChange(setArticlesData, index, 'imageUrl', await fileToBase64(e.target.files[0]), false)} onAiEdit={() => openAiModal(item.imageUrl, (newImg) => handleItemChange(setArticlesData, index, 'imageUrl', newImg, false))} showImageToggle={true} isImageShown={!!item.showImage} onImageToggleChange={e => handleItemChange(setArticlesData, index, 'showImage', e.target.checked, false)} />
                                        {renderInput(`Link`, item.link, e => handleItemChange(setArticlesData, index, 'link', e.target.value, false))}
                                        {renderTextarea(`Description`, item.description, e => handleItemChange(setArticlesData, index, 'description', e.target.value, false), {
                                            fieldKey: `article_desc_${index}`,
                                            prompt: "Rewrite this article description to be more insightful and concise.",
                                            currentValue: item.description,
                                            onGenerated: (newText) => handleItemChange(setArticlesData, index, 'description', newText, false)
                                        })}
                                    </div>
                                ))}
                            </div>
                    ...
                    {activeTab === 'security' && (
                        <div>
                            <h2 className="text-3xl font-bold mb-2 text-white font-heading">Security & AI Settings</h2>
                            <p className="text-slate-400 mb-6">Manage your password recovery method and AI feature preferences.</p>
                            <div className="bg-bg-secondary p-6 rounded-lg border border-border-color mb-6">
                              ...
                              {securityData.recoveryMethod === 'phrase' ? (
                                ...
                                <>
                                  <div className="mb-4">
                                    <label className="block text-slate-300 text-sm font-bold mb-2">Security Question</label>
                                    <select value={securityData.recoveryQuestion} onChange={e => setSecurityData({...securityData, recoveryQuestion: e.target.value})} className="shadow appearance-none border rounded w-full py-2 px-3 bg-slate-700 border-slate-600 text-white leading-tight focus:outline-none focus:shadow-outline focus:border-accent-primary">
                                  ...
                                  <p className="text-xs text-amber-400 mt-2">Answers are not case-sensitive.</p>
                                </>
                              )}
                            </div>
                             <div className="bg-bg-secondary p-6 rounded-lg border border-border-color">
                                <h3 className="text-xl font-semibold mb-4 text-accent-primary">AI Feature Settings</h3>
                                <ToggleSwitch 
                                ...
                                />
                                 <p className="text-xs text-slate-400 -mt-2 mb-2">Toggles the "Edit with AI" button for all images. Requires API key.</p>
                                <ToggleSwitch 
                                ...
                                />
                                 <p className="text-xs text-slate-400 -mt-2 mb-2">Toggles the "Enhance" buttons for text content. Requires API key.</p>
                                <ToggleSwitch 
                                    label="Show AI Chatbot on Site"
                                    checked={aiFeaturesConfig.showChatbot}
                                    onChange={e => setAiFeaturesConfig(prev => ({...prev, showChatbot: e.target.checked}))}
                                />
                                 <p className="text-xs text-slate-400 -mt-2 mb-2">Shows or hides the AI assistant chat widget for visitors. Requires API key.</p>
                            </div>
                            <button onClick={() => { saveData('securityData', securityData); saveData('aiFeaturesConfig', aiFeaturesConfig); }} className="mt-6 btn-admin btn-admin-primary">Save Settings</button>
                        </div>
                    )}
                  </main>
              </div>
      ...
      const App = () => {
        ...
        const [appData, setAppData] = useState({
            personalInfo: loadData('personalInfo', personalInfoDefault), navLinks: navLinksDefault, sections: loadData('sectionsConfig', sectionsDefault), educationData: loadData('educationData', educationDataDefault), experienceData: loadData('experienceData', experienceDataDefault), skillsData: loadData('skillsData', skillsDataDefault), awardsData: loadData('awardsData', awardsDataDefault), articlesData: loadData('articlesData', articlesDataDefault), projectsData: loadData('projectsData', projectsDataDefault), certificationsData: loadData('certificationsData', certificationsDataDefault),
            aiFeaturesConfig: loadData('aiFeaturesConfig', aiFeaturesConfigDefault),
        });
        ...
        useEffect(() => {
          ...
          if (preloader) {
            setTimeout(() => preloader.classList.add('loaded'), 100);
          }
          const handleHashChange = () => setIsAdminView(window.location.hash === '#admin');
          // FIX: Add types to props
          const handleStorageChange = (e: StorageEvent) => {
              const keysToWatch = ['personalInfo', 'sectionsConfig', 'educationData', 'experienceData', 'skillsData', 'awardsData', 'articlesData', 'projectsData', 'certificationsData', 'aiFeaturesConfig'];
              if (e.key && keysToWatch.includes(e.key)) {
                setAppData(prevData => ({...prevData,
                    personalInfo: loadData('personalInfo', personalInfoDefault),
                    sections: loadData('sectionsConfig', sectionsDefault),
                    educationData: loadData('educationData', educationDataDefault),
                    experienceData: loadData('experienceData', experienceDataDefault),
                    skillsData: loadData('skillsData', skillsDataDefault),
                    awardsData: loadData('awardsData', awardsDataDefault),
                    articlesData: loadData('articlesData', articlesDataDefault),
                    projectsData: loadData('projectsData', projectsDataDefault),
                    certificationsData: loadData('certificationsData', certificationsDataDefault),
                    aiFeaturesConfig: loadData('aiFeaturesConfig', aiFeaturesConfigDefault),
                }));
             }
          };
        ...
        const visibleSections = appData.sections.filter(s => s.visible);
        const sectionComponentMap = {
          about: <About personalInfo={appData.personalInfo} educationData={appData.educationData} />, experience: <Experience experienceData={appData.experienceData} />, skills: <Skills skillsData={appData.skillsData} />, awards: <Awards awardsData={appData.awardsData} />, articles: <Articles articlesData={appData.articlesData} />, projects: <Projects projectsData={appData.projectsData} />, certifications: <Certifications certificationsData={appData.certificationsData} />, contact: <Contact personalInfo={appData.personalInfo} />,
        };

        return (
          <>
            <Header personalInfo={appData.personalInfo} navLinks={appData.navLinks} theme={theme} toggleTheme={toggleTheme} />
            <main>
              <Hero personalInfo={appData.personalInfo} />
              {visibleSections.map(section => <React.Fragment key={section.id}>{sectionComponentMap[section.id]}</React.Fragment>)}
            </main>
            <Footer personalInfo={appData.personalInfo} />
            {appData.aiFeaturesConfig.showChatbot && <Chatbot portfolioData={appData} />}
          </>
        );
      };
